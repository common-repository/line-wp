...
namespace ArtisanWorkshop\WooCommerce\PluginFramework\v2_0_8;

if ( ! defined( 'ABSPATH' ) ) {
    exit;
}

if (!class_exists('\\ArtisanWorkshop\\WooCommerce\\PluginFramework\\v2_0_8\\JP4WC_Plugin')):
    class JP4WC_Plugin {
        /**
        ...
        public function jp4wc_support_notice( $support_form_url ){?>
            ...
            <p class="inner"><?php echo sprintf($this->text_array['support_notice_02'],$support_form_url.'?utm_source=wc4jp-settings&utm_medium=link&utm_campaign=top-pro');?></p>
        ...
        public function jp4wc_pro_notice( $jp4wc_pro_url ){?>
            ...
            <p class="inner"><?php echo sprintf($this->text_array['pro_notice_02'],$jp4wc_pro_url.'?utm_source=wc4jp-settings&utm_medium=link&utm_campaign=top-support');?></p>
